    ...
    return (
        <div className="overflow-hidden rounded-md shadow">
            <div className="h-full px-6 py-4 flex justify-between gap-6">
                ...
                <Button variant="ghost" className="hover:bg-zinc-200 dark:hover:bg-zinc-800 sm:flex hidden" onClick={() => router.push(pathname + "/submit")}><BsImage /></Button>
                <Button variant="ghost" className="hover:bg-zinc-200 dark:hover:bg-zinc-800 sm:flex hidden" onClick={() => router.push(pathname + "/submit")}><BsLink /></Button>
            </div>
        </div>
    )
}